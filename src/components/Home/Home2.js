        ...
        <Row style={{ justifyContent: "center", padding: "10px" }}>
          ...
          <Col md={7} className="home-about-description-card">
            ...
            <p className="home-about-body">
              An aspiring finance professional and MBA candidate passionate
              about
              <b className="purple"> analytics and Corporate Finance</b>. I have
              a strong foundation in Accounting, and a keen interest in
              <b className="purple"> financial modeling</b>, data-driven
              decision-making, and optimizing business processes to enhance
              efficiency.
              <br />
              <br />
              With an ability to lead teams and deliver results through
              analytical problem-solving, I am eager to apply my skills in a
              dynamic finance role to drive meaningful results.
              <br />
              <br />I eagerly find new avenues to learn, such as building this
              website to showcase about me.
              <br />
              <br />
